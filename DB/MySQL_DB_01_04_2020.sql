...
INSERT INTO `cliente` VALUES (8,'asdasd',1231,'asda','xxxxx'),(10,'Antonio',123,'test@test.com','xxxxx');
...
CREATE TABLE `condicoespagamento` (
  ...
  `nomeCondi` varchar(60) DEFAULT NULL,
  `nDiasCondi` bigint DEFAULT NULL,
  `descontoCondi` float DEFAULT NULL,
  PRIMARY KEY (`idCondi`)
...
INSERT INTO `condicoespagamento` VALUES ('xxxxx','Pagamento a 15 dias',NULL,NULL);
...
INSERT INTO `doccab` VALUES (1,1,'FT',8,'asdasd',1,'2020-03-24','1900-01-01'),(2,1,'FT',8,'asdasd',2,'2020-03-31','1900-01-01'),(3,4,'FS',8,'a',1,'2020-04-29','1900-01-01');
...
CREATE TABLE `doclin` (
  ...
  `precoTot` decimal(10,2) NOT NULL,
  PRIMARY KEY (`idLin`),
  KEY `idCab_idx` (`idCab`),
...
INSERT INTO `doclin` VALUES (1,9,'1234','aguaUP',1,1.50,1.50),(2,9,'1234','aguaUP',2,1.50,3.00),(3,10,'1234','aguaUP',1,1.50,1.50),(4,10,'1234','aguaUP',2,1.50,3.00),(5,1,'1234','aguaUP',1,1.50,1.50);
...
INSERT INTO `produto` VALUES ('1234','aguaUP','L','M',1.50,2.00,0.00,'1234'),('256','Coca','G','D',10.00,7.50,2.00,'');
...
-- Dump completed on 2020-04-01 19:07:50
