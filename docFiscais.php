        ...
        <div class='col-lg-1' id='paraRemover'> </div>
            <div class="col-lg-8" >
                <table class="table table-hover">
                    ...
                    ?>
                    <tr>
                        <td><?php echo $row['idCab'] ?></td>
                        <td><?php echo $row['codTipoDoc'] ?></td>
                        ...
                        <td>
                            <a href="<?php echo $path ?>/views/viewDocFiscais.php?id=<?php echo $row['idCab'];?>">Ver</a>
                        </td>
                        <td>
                            <a href="#" onclick="openModal(<?php echo $row['idCab'];?>,'<?php echo $currentPage?>', 'Eliminar')" data-target="#loadModal" data-toggle="modal" >Eliminar</a>
                        </td>
                        <td>
                            <a href="#" onclick="openModal(<?php echo $row['idCab'];?>,'<?php echo $currentPage?>', 'Anular')" data-target="#loadModal" data-toggle="modal" >Anular</a>
                        </td>
                    </tr>
                    <?php
                    }
