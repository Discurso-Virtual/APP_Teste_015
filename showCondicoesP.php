...
try
{
    ...
    $sql = "SELECT * FROM condicoespagamento" ;?>
      ...
      <div class="row" id="linha">
            ...
            <div class="col-lg-8" >
                <table class="table table-hover">
                    ...
                    ?>
                    <tr>
                        <td><?php echo $row['nomeCondi'] ?></td>
                        <td><?php echo $row['nDiasCondi'] ?></td>
                        <td><?php echo $row['descontoCondi'] ?></td>
                        <td>
                            <a href="#" onclick="openModal('<?php echo $row['idCondi'];?>','<?php echo $currentPage?>', 'Editar')" data-target="#loadModal" data-toggle="modal" >Editar</a>
                        </td>
                        <td>
                            <a href="#" onclick="openModal('<?php echo $row['idCondi'];?>','<?php echo $currentPage?>', 'Eliminar')" data-target="#loadModal" data-toggle="modal" >Eliminar</a>
                        </td>
                    </tr>
                    <?php
                    }
