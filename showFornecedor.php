      ...
      <div class='col-lg-1' id='paraRemover'> </div>
            <div class="col-lg-8">
                <table class="table table-hover">
                    ...
                    ?>
                    <tr ondblclick="verDetalhes('<?php echo $path?>/views/viewFornecedor.php?id=<?php echo $row['codForne'] ?>')">
                        <td><a href="<?php echo $path?>/views/viewFornecedor.php?id=<?php echo $row['codForne'] ?>"><i class="far fa-eye"></i></a></td>
