        ...
        <div class="row" id ="linha">
            ...
            <div class="col-lg-8">
                <table class="table table-hover">
                    ...
                    ?>
                    <tr ondblclick="verDetalhes('<?php echo $path?>/views/viewProduto.php?id=<?php echo $row['refProduto'] ?>')" >
                        <td><a href="<?php echo $path?>/views/viewProduto.php?id=<?php echo $row['refProduto'] ?>"><i class="far fa-eye"></i></a></td>
